...
while [ true ] 
    do
        ...
        y | yes ) 
            ...
            if [ $ver = "5.3" ];then
                pve5x
                echo "如果没有意外，安装完成! 浏览器打开 http://你的本机IP 去试试您的 OpenMediaVault 4!"
                exit
            elif [ $ver = "5.4" ];then
                pve5x
                echo "如果没有意外，安装完成! 浏览器打开 http://你的本机IP 去试试您的 OpenMediaVault 4!"
                ...
                pve6x
                echo "如果没有意外，安装完成! 浏览器打开 http://你的本机IP 去试试您的 OpenMediaVault 5!"
                exit
            elif [ $ver = "6.1" ];then
                pve6x
                echo "如果没有意外，安装完成! 浏览器打开 http://你的本机IP 去试试您的 OpenMediaVault 5!"
                ...
                echo "你的 Proxmox VE 版本不是 5.x/6.x ，不建议安装，即将退出。"
                break
            fi
        ;;
